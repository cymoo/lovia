...
const MESSAGES = {
  zh: {
    ...
    'cfg.modelId': '模型 ID',
    'cfg.fetchModels': '获取列表',
    'cfg.fetchHint': '端点未列出的模型也可以直接填写',
    'cfg.advanced': '高级',
...
const EN = {
  ...
  'cfg.flavorAnthropic': 'Anthropic',
  'cfg.baseUrl': 'Base URL',
  'cfg.baseUrlPreview': 'Requests go to {url}',
  'cfg.apiKey': 'API Key',
  ...
  'cfg.fetchModels': 'Fetch list',
  'cfg.fetchHint': 'Models the endpoint does not list can be typed in directly',
