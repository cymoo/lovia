...
const MESSAGES = {
  zh: {
    ...
    'cfg.skillsTitle': 'Skill 目录',
    'cfg.skillsIntro':
      '按顺序扫描以下目录加载 skills（每个 skill 是含 SKILL.md 的子目录）；重名时靠前的目录优先。目录内新增 skill 即时生效。',
    'cfg.skillsDefaultBadge': '默认',
    'cfg.skillsMissing': '目录不存在',
    'cfg.skillsEmpty': '未发现 skill',
    'cfg.skillsCount': '{n} 个 skill',
    'cfg.skillsProblems': '{n} 个问题',
    'cfg.skillsShow': '查看',
    'cfg.skillsShadowed': '被遮蔽',
    'cfg.skillsMore': '展开',
    'cfg.skillsLess': '收起',
    'cfg.skillsRemove': '移除',
    'cfg.skillsAdd': '添加目录',
    'cfg.skillsPathPlaceholder': '~/my-skills',
    'cfg.skillsRestore': '恢复默认目录',
    'cfg.skillsNone': '尚未配置任何目录',
    'cfg.aboutVersion': '版本',
...
const EN = {
  ...
  'cfg.searchOff': 'Off',
  'cfg.tavilyKey': 'Tavily API Key',
  'cfg.skillsTitle': 'Skill directories',
  'cfg.skillsIntro':
    'Skills load from these directories in order (each skill is a '
    + 'subdirectory with a SKILL.md); on duplicate names the earlier '
    + 'directory wins. New skills in a listed directory work right away.',
  'cfg.skillsDefaultBadge': 'default',
  'cfg.skillsMissing': 'directory not found',
  'cfg.skillsEmpty': 'no skills found',
  'cfg.skillsCount': '{n} skills',
  'cfg.skillsProblems': '{n} problems',
  'cfg.skillsShow': 'Details',
  'cfg.skillsShadowed': 'shadowed',
  'cfg.skillsMore': 'More',
  'cfg.skillsLess': 'Less',
  'cfg.skillsRemove': 'Remove',
  'cfg.skillsAdd': 'Add directory',
  'cfg.skillsPathPlaceholder': '~/my-skills',
  'cfg.skillsRestore': 'Restore default directories',
  'cfg.skillsNone': 'No directories configured',
